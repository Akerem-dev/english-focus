...
The standard Quality workflow now includes a Windows native-test job in addition to the existing JavaScript quality job. The native job compiles the Tauri crate and runs Rust tests on every pull request.
