...
export function renderVocabularyInstructionRules(
  ...
  return [
    ...
    "- Keep wordFamily, collocations, relatedWords, and commonMistakes empty; they are legacy compatibility fields.",
    "- Keep phrasalVerbs and idioms empty for the single-word entry.",
