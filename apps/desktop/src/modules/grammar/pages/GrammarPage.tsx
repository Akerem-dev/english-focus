      ...
      <section className="wvg-topic__paper">
        <header className="wvg-topic__hero">
          <div className="wvg-topic__intro">
            ...
            <p>
              Past tense gibi yalnızca “ne oldu?” demez. Geçmişte olan şeyin bugünle bağlantısına
              odaklanır.
            </p>
          </div>
          <div className="wvg-topic__turkish">
            ...
            <p>
              Geçmişte bir şey oldu; ama cümlenin asıl derdi o olayın tam olarak ne zaman olduğu
              değil, bugün sonucu var mı, deneyim mi, yoksa hâlâ devam mı ediyor sorusudur.
            </p>
          </div>
        </header>
        ...
        <nav className="wvg-topic-tabs" aria-label="Present Perfect lesson sections">
          ...
          <button
            ...
            className={tab === "compare" ? "is-active" : undefined}
          ...
          <button
            ...
            className={tab === "practice" ? "is-active" : undefined}
    ...
    <div className="wvg-rule-layout">
      <article className="wvg-rule-main">
        <section className="wvg-pattern" aria-labelledby="present-perfect-pattern-title">
          ...
          <div className="wvg-pattern__steps">
            <span>
              <strong>I / you / we / they</strong> → have
            </span>
            <span>
              <strong>he / she / it</strong> → has
            </span>
            <span>
              <strong>main verb</strong> → V3: done, gone, seen, eaten…
            </span>
          </div>
        ...
        <section className="wvg-rule-breakdown">
          ...
          <p>
            Present Perfect’i öğrenirken önce “Türkçede hangi zamana denk geliyor?” diye düşünme.
            Çünkü tek bir Türkçe zaman karşılığı yok. Onun yerine şunu sor:{" "}
            <strong>Geçmişte olan bu olayın şimdiyle bağlantısı var mı?</strong> Cevap evetse
            Present Perfect güçlü bir adaydır.
          </p>
          <ol>
            <li>
              <strong>Olay geçmişte oldu.</strong>
              <span>Ama geçmişteki kesin saat veya tarih çoğu zaman önemli değil.</span>
            </li>
            <li>
              <strong>Şimdiyle bağlantı var.</strong>
              <span>
                Sonuç şimdi devam ediyor, deneyim bugün için önemli ya da durum hâlâ sürüyor.
              </span>
            </li>
            <li>
              <strong>Bitmiş geçmiş zamanı söylemiyoruz.</strong>
              <span>
                “Yesterday”, “last year”, “in 2020” gibi bitmiş zaman verirsek genellikle Past
                Simple kullanırız.
              </span>
            </li>
          </ol>
        ...
        <section className="wvg-rule-copy">
          ...
          <p>
            The Present Perfect does not simply describe “the past”. It looks backward from the
            present moment. The exact past time is usually not the focus. What matters is the result
            we can see now, the experience a person has up to now, the duration of a situation that
            continues now, or an event inside a time period that has not finished yet.
          </p>
          <p className="wvg-rule-copy__tr">
            Yani “Ne zaman oldu?” sorusundan çok “Bunun şu anla ne ilgisi var?” sorusuna cevap
            verir. Bu yüzden Türkçede bazen “yaptım”, bazen “hiç yaptın mı?”, bazen de “...den beri
            yapıyorum” diye çevrilir. İngilizce aynı yapıyı kullanır; Türkçe çeviri bağlama göre
            değişir.
          </p>
        </section>
        ...
        <section className="wvg-rule-check" aria-label="Present Perfect decision check">
          ...
          <div>
            <strong>1.</strong>
            <span>
              Kesin ve bitmiş bir geçmiş zaman söylüyor muyum? <b>Evetse:</b> büyük ihtimalle Past
              Simple.
            </span>
          </div>
          <div>
            <strong>2.</strong>
            <span>
              Sonuç şu anda önemli mi, deneyimden mi söz ediyorum, yoksa durum hâlâ sürüyor mu?{" "}
              <b>Evetse:</b> Present Perfect olabilir.
            </span>
          </div>
          <div>
            <strong>3.</strong>
            <span>
              Cümlede since, for, ever, never, just, already, yet gibi ipuçları var mı? Bunlar tek
              başına kural değildir ama güçlü işaretlerdir.
            </span>
          </div>
        </section>
        ...
        <section className="wvg-rule-examples" aria-label="Present Perfect quick examples">
          <div>
            ...
            <span>
              <b>Şu anki sonuç:</b> Anahtarlar hâlâ bende değil; kapıyı açamıyorum.
            </span>
          </div>
          <div>
            <strong>We’ve lived here for six years.</strong>
            <span>
              <b>Devam eden durum:</b> Altı yıl önce başladık ve hâlâ burada yaşıyoruz.
            </span>
          </div>
          <div>
            <strong>Have you ever tried skiing?</strong>
            <span>
              <b>Hayat deneyimi:</b> Tam olarak ne zaman yaptığın önemli değil; bugüne kadarki
              deneyimin soruluyor.
            </span>
          </div>
        </section>
      ...
      <aside className="wvg-rule-notes" aria-label="Present Perfect reference notes">
        ...
        <section>
          ...
          <div className="wvg-signal-words">
            just · already · yet · ever · never · since · for · recently
          </div>
          <span className="wvg-note-explainer">
            Bunları görünce otomatik Present Perfect seçme. Önce cümlenin anlamına ve zamanın bitip
            bitmediğine bak.
          </span>
        </section>
        <section className="wvg-common-mistake">
          ...
          <span>
            “Yesterday” tamamen bitmiş bir geçmiş zamanı gösterir. Bu yüzden burada Present Perfect
            değil Past Simple doğal seçimdir.
          </span>
        </section>
      </aside>
    </div>
    ...
    <section className="wvg-examples-view" aria-labelledby="present-perfect-examples-title">
      <header className="wvg-examples-intro">
        <div className="wvg-examples-intro__copy">
          ...
          <h2 id="present-perfect-examples-title">
            Cümleyi ezberleme; neden bu zamanı seçtiğimizi gör.
          </h2>
        </div>
        <p className="wvg-examples-intro__guide">
          Her örnekte önce İngilizce cümleyi oku, sonra Türkçesine bak ve en son “neden Present
          Perfect?” açıklamasını kontrol et.
        </p>
      </header>
        ...
        {examples.map((example, index) => (
          <article className="wvg-example-row" key={example.sentence}>
            ...
            <div className="wvg-example-row__why">
              ...
              <p>
                <strong>Neden?</strong> {example.why}
              </p>
            </div>
          </article>
        ))}
      ...
      <aside className="wvg-examples-note">
        ...
        <p>
          Present Perfect’i yalnızca <strong>have/has + V3</strong> formülü olarak ezberlersen
          karışır. Önce anlamı seç: <strong>bugünle bağlantı</strong> var mı? Sonra formülü kur.
          Böyle düşünürsen Past Simple ile farkı çok daha kolay oturur.
        </p>
      </aside>
    </section>
  );
    ...
    <section className="wvg-compare-view" aria-labelledby="present-perfect-compare-title">
      <header className="wvg-compare-intro">
        <div>
          ...
          <span>
            Formülden önce zamanın nasıl görüldüğüne bak. İki yapı da geçmişten söz edebilir; fark,
            konuşanın geçmişi bugünden mi gördüğü yoksa bitmiş bir geçmiş zamanın içine mi
            yerleştirdiğidir.
          </span>
        </div>
        <aside>
          ...
          <p>
            <b>Bitmiş zaman söylüyorsan:</b> Past Simple.
          </p>
          <p>
            <b>Bitmiş zaman yok ve bugünle bağlantı varsa:</b> Present Perfect.
          </p>
        </aside>
      </header>
      ...
      <div className="wvg-compare-columns">
        <article data-side="perfect">
          ...
          <p>
            Geçmişte olan şeye <strong>bugünden bakar.</strong> Sonuç şimdi önemli olabilir, deneyim
            bugüne kadar sürebilir veya durum hâlâ devam ediyor olabilir.
          </p>
          <ul>
        ...
        <article data-side="simple">
          ...
          <p>
            Olayı <strong>bitmiş geçmiş zamanın içinde</strong> anlatır. Olayın bugün sonucu olup
            olmaması gramer seçiminde asıl mesele değildir.
          </p>
          <ul>
      ...
      <section
        className="wvg-compare-pairs"
        aria-label="Present Perfect and Past Simple paired examples"
      >
      ...
      <section className="wvg-compare-decision">
        ...
        <div>
          <strong>1</strong>
          <span>
            Cümlede yesterday, last..., ago, in 2020 gibi <b>bitmiş geçmiş zaman</b> var mı? →{" "}
            <b>Past Simple.</b>
          </span>
        </div>
        <div>
          <strong>2</strong>
          <span>
            Yoksa olayın <b>şu anki sonucu, bugüne kadarki deneyimi veya hâlâ süren durumu</b> mu
            önemli? → <b>Present Perfect.</b>
          </span>
        </div>
        <div>
          <strong>3</strong>
          <span>
            Hâlâ emin değilsen “Ne zaman oldu?” diye sor. Cevap belirli ve bitmiş bir geçmiş zamansa
            Past Simple tarafına yaklaş.
          </span>
        </div>
      </section>
      ...
      <aside className="wvg-compare-warning">
        ...
        <p>
          <del>I have seen her yesterday.</del> <b>I saw her yesterday.</b> “Yesterday” bitmiş bir
          zaman olduğu için Present Perfect kullanamayız.
        </p>
      </aside>
    </section>
  );
