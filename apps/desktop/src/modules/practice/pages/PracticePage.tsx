...
import "../../../styles/word-valley-practice-polish.css";
...
interface TrainingGround {
  readonly id: Exclude<PracticeView, "home" | "expedition" | "summary">;
...
export function PracticePage() {
  ...
  if (view !== "home") {
    ...
    if (view === "expedition") {
      ...
      practiceView = <PracticeMemoryGrove deck={deck} entries={entries} onExit={() => setView("home")} />;
    } else if (view === "word-forge") {
      practiceView = <PracticeWordForge deck={deck} entries={entries} onExit={() => setView("home")} />;
    } else if (view === "context-bridge") {
      practiceView = <PracticeContextBridge deck={deck} entries={entries} onExit={() => setView("home")} />;
    } else if (view === "phrase-falls") {
      practiceView = <PracticePhraseFalls deck={deck} entries={entries} onExit={() => setView("home")} />;
  ...
  return (
    <div className="wvp-page">
      ...
      <main aria-label="Practice" className="wvp-shell">
        <section aria-labelledby="practice-title" className="wvp-home">
          <header className="wvp-home__header">
            <div className="wvp-home__heading">
              ...
              <p>Short, adaptive sessions built from your words, weak spots, and recent mistakes.</p>
            </div>
          ...
          <section aria-label="Today's expedition" className="wvp-expedition-card">
            <img
              alt=""
            ...
            <div className="wvp-expedition-card__copy">
              ...
              <div aria-label="Today's review mix" className="wvp-expedition-card__chips">
                <span>
            ...
            <div aria-label="Expedition route" className="wvp-expedition-route">
              {["Grove", "Forge", "Bridge", "Summit"].map((label, index) => (
                <div className="wvp-expedition-route__stop" data-active={index === 0 || undefined} key={label}>
                  <i aria-hidden="true" />
                  <span>{label}</span>
                </div>
              ))}
          ...
          <section aria-label="Training grounds" className="wvp-training-grid">
          ...
          <div className="wvp-home__bottom">
            <section aria-labelledby="focus-practice-title" className="wvp-focus-panel">
              ...
              <div aria-label="Focus practice filter" className="wvp-focus-pills" role="group">
            ...
            <section aria-labelledby="week-title" className="wvp-week-panel">
              <header>
                <div>
